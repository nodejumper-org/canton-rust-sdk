    ...
    pub mod Splice_Api_Token_TransferInstructionV1 {
            ...
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    extra_actors: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "extraActors")?,
                        )
            ...
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ...
                        self.transfer)), ("status", rt::ToValue::to_value(& self
                        .status)), ("meta", rt::ToValue::to_value(& self.meta)),
                    ],
                )
            }
        }
            ...
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    transfer: rt::FromValue::from_value(
                        ...
                        .map_err(|e| e.at("transfer"))?,
                    status: rt::FromValue::from_value(
                            rt::required_field(value, 2usize, "status")?,
                        )
        ...
        impl rt::ToValue for TransferInstructionStatus_TransferPendingInternalWorkflow {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("pendingActions", rt::ToValue::to_value(& self
                        .pending_actions)),
                    ],
                )
            }
        ...
        impl rt::FromValue
        for TransferInstructionStatus_TransferPendingInternalWorkflow {
            fn from_value(
                value: &rt::Value,
            ) -> ::core::result::Result<Self, rt::ValueError> {
                ::core::result::Result::Ok(Self {
                    pending_actions: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "pendingActions")?,
                        )
        ...
        impl rt::Contract for TransferFactory {
            const PACKAGE_ID: &'static str = "55ba4deb0ad4662c4168b39859738a0e91388d252286480c7331b3f71a517281";
