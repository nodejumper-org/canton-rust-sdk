    ...
    pub mod Splice_Api_Token_AllocationRequestV2 {
        ...
        impl rt::ToValue for AllocationRequestView {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("originalRequestCid", rt::ToValue::to_value(& self
                        .original_request_cid)), ("settlement", rt::ToValue::to_value(&
                        self.settlement)), ("allocations", rt::ToValue::to_value(& self
                        .allocations)), ("requestedAt", rt::ToValue::to_value(& self
                        .requested_at)), ("settleAt", rt::ToValue::to_value(& self
                        .settle_at)), ("availableActions", rt::ToValue::to_value(& self
        ...
        impl rt::FromValue for AllocationRequestView {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    original_request_cid: rt::optional_field(
                            value,
                            0usize,
                            "originalRequestCid",
                        )
                    ...
                    available_actions: rt::FromValue::from_value(
                            rt::required_field(value, 5usize, "availableActions")?,
                        )
                ...
                match constructor {
                    "ARA_Accept" => {
                        ::core::result::Result::Ok(
                            AllocationRequestAction::ARA_Accept(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("ARA_Accept"))?,
                            ),
                        )
                    }
                    "ARA_Reject" => {
                        ::core::result::Result::Ok(
                            AllocationRequestAction::ARA_Reject(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("ARA_Reject"))?,
                            ),
                        )
                    }
                    "ARA_Custom" => {
                        ::core::result::Result::Ok(
                            AllocationRequestAction::ARA_Custom(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("ARA_Custom"))?,
                            ),
                        )
                    }
                    other => {
                        ::core::result::Result::Err(
                            rt::unexpected_constructor("AllocationRequestAction", other),
                        )
                    }
                }
            }
        ...
        impl rt::Contract for AllocationRequest {
            const PACKAGE_ID: &'static str = "adc16315a8943a8433886694720a2a000ae84c2315c4414bd6d0db4d1660de9c";
