    ...
    pub mod Splice_Api_FeaturedAppRightV1 {
        ...
        impl rt::ToValue for FeaturedAppRight_CreateActivityMarkerResult {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("activityMarkerCids", rt::ToValue::to_value(& self
                        .activity_marker_cids)),
                    ],
                )
            }
        }
        impl rt::FromValue for FeaturedAppRight_CreateActivityMarkerResult {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    activity_marker_cids: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "activityMarkerCids")?,
                        )
        ...
        impl rt::FromValue for FeaturedAppRight_CreateActivityMarker {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    beneficiaries: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "beneficiaries")?,
                        )
        ...
        impl rt::FromValue for AppRewardBeneficiary {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    beneficiary: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "beneficiary")?,
                        )
                        .map_err(|e| e.at("beneficiary"))?,
                    weight: rt::FromValue::from_value(
                            rt::required_field(value, 1usize, "weight")?,
                        )
                        .map_err(|e| e.at("weight"))?,
                })
            }
        ...
        impl rt::Contract for FeaturedAppActivityMarker {
            const PACKAGE_ID: &'static str = "7804375fe5e4c6d5afe067bd314c42fe0b7d005a1300019c73154dd939da4dda";
