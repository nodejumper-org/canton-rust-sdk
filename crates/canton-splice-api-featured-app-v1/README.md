...
Pre-built typed Rust bindings for the Splice featured-app API (`splice-api-featured-app-v1`), generated from
`splice-api-featured-app-v1-1.0.0.dar` by [`canton-codegen`](https://crates.io/crates/canton-codegen).

```sh
cargo add canton-splice-api-featured-app-v1
```
