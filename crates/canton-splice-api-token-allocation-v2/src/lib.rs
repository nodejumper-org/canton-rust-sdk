    ...
    pub mod Splice_Api_Token_AllocationV2 {
        ...
        impl rt::ToValue for SettlementFactory_SettleBatchResult {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("allocationSettleResults", rt::ToValue::to_value(& self
                        .allocation_settle_results)), ("meta", rt::ToValue::to_value(&
                        self.meta)),
                    ],
                )
            }
        ...
        impl rt::FromValue for SettlementFactory_SettleBatchResult {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    allocation_settle_results: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "allocationSettleResults")?,
                        )
        ...
        impl rt::ToValue for SettlementFactory_PublicFetch {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![("actors", rt::ToValue::to_value(& self.actors)),],
                )
            }
        }
        impl rt::FromValue for SettlementFactory_PublicFetch {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    actors: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "actors")?,
                        )
            ...
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ...
                        ("actors", rt::ToValue::to_value(& self.actors)), ("extraArgs",
        ...
        impl rt::FromValue for SettlementFactory_SettleBatch {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    allocations: rt::FromValue::from_value(
                            rt::required_field(value, 2usize, "allocations")?,
                        )
                        .map_err(|e| e.at("allocations"))?,
                    actors: rt::FromValue::from_value(
                            rt::required_field(value, 3usize, "actors")?,
                        )
                        .map_err(|e| e.at("actors"))?,
                    extra_args: rt::FromValue::from_value(
                            rt::required_field(value, 4usize, "extraArgs")?,
                        )
                ...
                match constructor {
                    ...
                    other => {
                        ::core::result::Result::Err(
                            rt::unexpected_constructor("AllocationResult_Output", other),
                        )
                    }
                }
            }
        ...
        impl rt::ToValue for AllocationResult_Output_AllocationResult_Settled {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("nextIterationAllocationCid", rt::ToValue::to_value(& self
                        .next_iteration_allocation_cid)),
                    ],
                )
            }
        }
            ...
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ...
                        ("authorizerHoldingCids", rt::ToValue::to_value(& self
                        .authorizer_holding_cids)), ("meta", rt::ToValue::to_value(& self
                        .meta)),
                    ],
                )
            }
        ...
        impl rt::FromValue for AllocationResult {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    output: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "output")?,
                        )
                        .map_err(|e| e.at("output"))?,
                    authorizer_holding_cids: rt::FromValue::from_value(
                            rt::required_field(value, 1usize, "authorizerHoldingCids")?,
                        )
            ...
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ...
                        ("extraTransferLegSides", rt::ToValue::to_value(& self
                        .extra_transfer_leg_sides)), ("nextIterationFunding",
            ...
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    actors: rt::FromValue::from_value(
                        ...
                        .map_err(|e| e.at("actors"))?,
                    extra_transfer_leg_sides: rt::FromValue::from_value(
                            rt::required_field(value, 1usize, "extraTransferLegSides")?,
                        )
                    ...
                    extra_args: rt::FromValue::from_value(
                            rt::required_field(value, 3usize, "extraArgs")?,
                        )
                        .map_err(|e| e.at("extraArgs"))?,
                })
            }
        ...
        impl rt::ToValue for AllocationView {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("originalAllocationCid", rt::ToValue::to_value(& self
                        .original_allocation_cid)), ("settlement",
                        rt::ToValue::to_value(& self.settlement)), ("allocation",
                        rt::ToValue::to_value(& self.allocation)), ("holdingCids",
                        rt::ToValue::to_value(& self.holding_cids)), ("createdAt",
                        rt::ToValue::to_value(& self.created_at)), ("numIterations",
                        rt::ToValue::to_value(& self.num_iterations)), ("expiresAt",
                        rt::ToValue::to_value(& self.expires_at)), ("availableActions",
                        rt::ToValue::to_value(& self.available_actions)), ("meta",
                        rt::ToValue::to_value(& self.meta)),
                    ],
                )
            }
        ...
        impl rt::FromValue for AllocationView {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    settlement: rt::FromValue::from_value(
                            rt::required_field(value, 1usize, "settlement")?,
                        )
                        .map_err(|e| e.at("settlement"))?,
                    allocation: rt::FromValue::from_value(
                            rt::required_field(value, 2usize, "allocation")?,
                        )
                        .map_err(|e| e.at("allocation"))?,
                    holding_cids: rt::FromValue::from_value(
                            rt::required_field(value, 3usize, "holdingCids")?,
                        )
                        .map_err(|e| e.at("holdingCids"))?,
                    created_at: rt::FromValue::from_value(
                            rt::required_field(value, 4usize, "createdAt")?,
                        )
                        .map_err(|e| e.at("createdAt"))?,
                    num_iterations: rt::FromValue::from_value(
                            rt::required_field(value, 5usize, "numIterations")?,
                        )
                        .map_err(|e| e.at("numIterations"))?,
                    expires_at: rt::optional_field(value, 6usize, "expiresAt")
                        .map_err(|e| e.at("expiresAt"))?,
                    available_actions: rt::FromValue::from_value(
                            rt::required_field(value, 7usize, "availableActions")?,
                        )
                        .map_err(|e| e.at("availableActions"))?,
                    meta: rt::FromValue::from_value(
                            rt::required_field(value, 8usize, "meta")?,
                        )
                        .map_err(|e| e.at("meta"))?,
                })
            }
        ...
        impl rt::FromValue for AllocationAction {
            fn from_value(
                ...
                match constructor {
                    "AA_Settle" => {
                        ::core::result::Result::Ok(
                            AllocationAction::AA_Settle(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AA_Settle"))?,
                            ),
                        )
                    }
                    "AA_Cancel" => {
                        ::core::result::Result::Ok(
                            AllocationAction::AA_Cancel(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AA_Cancel"))?,
                            ),
                        )
                    }
                    "AA_Withdraw" => {
                        ::core::result::Result::Ok(
                            AllocationAction::AA_Withdraw(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AA_Withdraw"))?,
                            ),
                        )
                    }
                    "AA_Custom" => {
                        ::core::result::Result::Ok(
                            AllocationAction::AA_Custom(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AA_Custom"))?,
                            ),
                        )
                    }
                    other => {
                        ::core::result::Result::Err(
                            rt::unexpected_constructor("AllocationAction", other),
                        )
                    }
                }
            }
        ...
        impl rt::ToValue for AllocationSpecification {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("admin", rt::ToValue::to_value(& self.admin)), ("authorizer",
                        rt::ToValue::to_value(& self.authorizer)), ("transferLegSides",
                        rt::ToValue::to_value(& self.transfer_leg_sides)),
                        ("settlementDeadline", rt::ToValue::to_value(& self
                        .settlement_deadline)), ("nextIterationFunding",
                        rt::ToValue::to_value(& self.next_iteration_funding)),
                        ("committed", rt::ToValue::to_value(& self.committed)), ("meta",
                        rt::ToValue::to_value(& self.meta)),
                    ],
                )
            }
            ...
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    admin: rt::FromValue::from_value(
                        ...
                        .map_err(|e| e.at("admin"))?,
                    authorizer: rt::FromValue::from_value(
                            rt::required_field(value, 1usize, "authorizer")?,
                        )
                        .map_err(|e| e.at("authorizer"))?,
                    transfer_leg_sides: rt::FromValue::from_value(
                            rt::required_field(value, 2usize, "transferLegSides")?,
                        )
                        .map_err(|e| e.at("transferLegSides"))?,
                    settlement_deadline: rt::optional_field(
                            value,
                            3usize,
                            "settlementDeadline",
                        )
                    ...
                    next_iteration_funding: rt::optional_field(
                        ...
                        .map_err(|e| e.at("nextIterationFunding"))?,
                    committed: rt::FromValue::from_value(
                            rt::required_field(value, 5usize, "committed")?,
                        )
                        .map_err(|e| e.at("committed"))?,
                    meta: rt::FromValue::from_value(
                            rt::required_field(value, 6usize, "meta")?,
                        )
                        .map_err(|e| e.at("meta"))?,
                })
            }
        ...
        impl rt::ToValue for SettlementInfo {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("executors", rt::ToValue::to_value(& self.executors)), ("id",
                        rt::ToValue::to_value(& self.id)), ("cid",
                        rt::ToValue::to_value(& self.cid)), ("meta",
                        rt::ToValue::to_value(& self.meta)),
                    ],
                )
            }
        ...
        impl rt::FromValue for SettlementInfo {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    executors: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "executors")?,
                        )
                    ...
                    id: rt::FromValue::from_value(
                        ...
                        .map_err(|e| e.at("id"))?,
                    cid: rt::optional_field(value, 2usize, "cid")
                        .map_err(|e| e.at("cid"))?,
                    meta: rt::FromValue::from_value(
                            rt::required_field(value, 3usize, "meta")?,
                        )
                        .map_err(|e| e.at("meta"))?,
                })
            }
        ...
        impl rt::Contract for Allocation {
            const PACKAGE_ID: &'static str = "051a3b0563a6fa4df4cb34448081e48b061e555aa1a265abf6ae8f3f4cafe439";
