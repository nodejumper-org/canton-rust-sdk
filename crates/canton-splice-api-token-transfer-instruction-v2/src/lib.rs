    ...
    pub mod Splice_Api_Token_TransferInstructionV2 {
        ...
        impl rt::ToValue for TransferFactory_Transfer {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("transfer", rt::ToValue::to_value(& self.transfer)), ("actors",
                        rt::ToValue::to_value(& self.actors)), ("extraArgs",
        ...
        impl rt::FromValue for TransferFactory_Transfer {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    actors: rt::FromValue::from_value(
                            rt::required_field(value, 1usize, "actors")?,
                        )
                        .map_err(|e| e.at("actors"))?,
        ...
        impl rt::ToValue for TransferInstructionView {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("originalInstructionCid", rt::ToValue::to_value(& self
                        .original_instruction_cid)), ("transfer", rt::ToValue::to_value(&
                        self.transfer)), ("expiresAt", rt::ToValue::to_value(& self
                        .expires_at)), ("availableActions", rt::ToValue::to_value(& self
                        .available_actions)), ("meta", rt::ToValue::to_value(& self
                        .meta)),
                    ],
                )
            }
            ...
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    available_actions: rt::FromValue::from_value(
                            rt::required_field(value, 3usize, "availableActions")?,
                        )
                ...
                match constructor {
                    "TIA_Accept" => {
                        ::core::result::Result::Ok(
                            TransferInstructionAction::TIA_Accept(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("TIA_Accept"))?,
                            ),
                        )
                    }
                    "TIA_Reject" => {
                        ::core::result::Result::Ok(
                            TransferInstructionAction::TIA_Reject(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("TIA_Reject"))?,
                            ),
                        )
                    }
                    "TIA_Withdraw" => {
                        ::core::result::Result::Ok(
                            TransferInstructionAction::TIA_Withdraw(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("TIA_Withdraw"))?,
                            ),
                        )
                    }
                    "TIA_Custom" => {
                        ::core::result::Result::Ok(
                            TransferInstructionAction::TIA_Custom(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("TIA_Custom"))?,
                            ),
                        )
                    }
                    other => {
        ...
        impl rt::ToValue
        for TransferInstructionResult_Output_TransferInstructionResult_Pending {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
        ...
        impl rt::ToValue
        for TransferInstructionResult_Output_TransferInstructionResult_Completed {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("receiverHoldingCids", rt::ToValue::to_value(& self
            ...
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    receiver_holding_cids: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "receiverHoldingCids")?,
                        )
            ...
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ...
                        ("senderChangeCids", rt::ToValue::to_value(& self
                        .sender_change_cids)), ("meta", rt::ToValue::to_value(& self
                        .meta)),
                    ],
                )
            }
        ...
        impl rt::FromValue for TransferInstructionResult {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    sender_change_cids: rt::FromValue::from_value(
                            rt::required_field(value, 1usize, "senderChangeCids")?,
                        )
            ...
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ...
                        rt::ToValue::to_value(& self.instrument_id)), ("requestedAt",
                        rt::ToValue::to_value(& self.requested_at)), ("executeBefore",
                        rt::ToValue::to_value(& self.execute_before)),
                        ("inputHoldingCids", rt::ToValue::to_value(& self
                        .input_holding_cids)), ("meta", rt::ToValue::to_value(& self
                        .meta)),
                    ],
                )
            }
        ...
        impl rt::FromValue for Transfer {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    execute_before: rt::FromValue::from_value(
                            rt::required_field(value, 5usize, "executeBefore")?,
                        )
                        .map_err(|e| e.at("executeBefore"))?,
                    input_holding_cids: rt::FromValue::from_value(
                            rt::required_field(value, 6usize, "inputHoldingCids")?,
                        )
                        .map_err(|e| e.at("inputHoldingCids"))?,
                    meta: rt::FromValue::from_value(
                            rt::required_field(value, 7usize, "meta")?,
                        )
                        .map_err(|e| e.at("meta"))?,
                })
            }
        ...
        impl rt::Contract for TransferFactory {
            const PACKAGE_ID: &'static str = "29317e3b7b165d2bbf16721bcca0ec4869e53eddb2738bddf790d61af28e0099";
