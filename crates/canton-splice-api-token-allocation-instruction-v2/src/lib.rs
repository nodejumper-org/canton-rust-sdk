...
pub mod splice_api_token_allocation_instruction_v2 {
    pub mod Splice_Api_Token_AllocationInstructionV2 {
        ...
        impl rt::ToValue
        for AllocationInstructionResult_Output_AllocationInstructionResult_Pending {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("allocationInstructionCid", rt::ToValue::to_value(& self
        ...
        for AllocationInstructionResult_Output_AllocationInstructionResult_Pending {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    allocation_instruction_cid: rt::FromValue::from_value(
                            rt::required_field(
                                value,
                                0usize,
        ...
        impl rt::ToValue
        for AllocationInstructionResult_Output_AllocationInstructionResult_Completed {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
            ...
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ...
                        ("authorizerChangeCids", rt::ToValue::to_value(& self
                        .authorizer_change_cids)), ("meta", rt::ToValue::to_value(& self
                        .meta)),
                    ],
                )
            }
        ...
        impl rt::FromValue for AllocationInstructionResult {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    authorizer_change_cids: rt::FromValue::from_value(
                            rt::required_field(value, 1usize, "authorizerChangeCids")?,
                        )
            ...
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ...
                        .input_holding_cids)), ("extraArgs", rt::ToValue::to_value(& self
                        .extra_args)), ("actors", rt::ToValue::to_value(& self.actors)),
                    ],
                )
            }
        }
            ...
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    input_holding_cids: rt::FromValue::from_value(
                            rt::required_field(value, 3usize, "inputHoldingCids")?,
                        )
                    ...
                    actors: rt::FromValue::from_value(
                            rt::required_field(value, 5usize, "actors")?,
                        )
                        .map_err(|e| e.at("actors"))?,
                })
            }
            ...
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ...
                        .original_instruction_cid)), ("settlement",
                        rt::ToValue::to_value(& self.settlement)), ("allocation",
                        rt::ToValue::to_value(& self.allocation)), ("requestedAt",
                        rt::ToValue::to_value(& self.requested_at)), ("inputHoldingCids",
                        rt::ToValue::to_value(& self.input_holding_cids)), ("expiresAt",
            ...
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    ...
                    allocation: rt::FromValue::from_value(
                        ...
                        .map_err(|e| e.at("allocation"))?,
                    requested_at: rt::FromValue::from_value(
                            rt::required_field(value, 3usize, "requestedAt")?,
                        )
                        .map_err(|e| e.at("requestedAt"))?,
                    input_holding_cids: rt::FromValue::from_value(
                            rt::required_field(value, 4usize, "inputHoldingCids")?,
                        )
                        .map_err(|e| e.at("inputHoldingCids"))?,
                    expires_at: rt::optional_field(value, 5usize, "expiresAt")
                        .map_err(|e| e.at("expiresAt"))?,
                    available_actions: rt::FromValue::from_value(
                            rt::required_field(value, 6usize, "availableActions")?,
                        )
        ...
        impl rt::FromValue for AllocationInstructionAction {
            fn from_value(
                ...
                match constructor {
                    "AIA_Withdraw" => {
                        ::core::result::Result::Ok(
                            AllocationInstructionAction::AIA_Withdraw(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AIA_Withdraw"))?,
                            ),
                        )
                    }
                    "AIA_Accept" => {
                        ::core::result::Result::Ok(
                            AllocationInstructionAction::AIA_Accept(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AIA_Accept"))?,
                            ),
                        )
                    }
                    "AIA_Custom" => {
                        ::core::result::Result::Ok(
                            AllocationInstructionAction::AIA_Custom(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AIA_Custom"))?,
                            ),
                        )
                    }
                    other => {
        ...
        impl rt::Contract for AllocationFactory {
            const PACKAGE_ID: &'static str = "9818a0b5b827109de03a04c8f6151cde9d1e7fe5123dbb2dfeb0e52d7271287c";
