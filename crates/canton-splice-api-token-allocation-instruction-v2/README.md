...
Pre-built typed Rust bindings for the Splice `splice-api-token-allocation-instruction-v2` package
— the CIP-0112 (V2) token standard's allocation instructions.
