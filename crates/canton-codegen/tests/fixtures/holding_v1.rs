    ...
    pub mod Splice_Api_Token_HoldingV1 {
        ...
        impl rt::ToValue for HoldingView {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("owner", rt::ToValue::to_value(& self.owner)), ("instrumentId",
                        rt::ToValue::to_value(& self.instrument_id)), ("amount",
        ...
        impl rt::Contract for Holding {
            const PACKAGE_ID: &'static str = "718a0f77e505a8de22f188bd4c87fe74101274e9d4cb1bfac7d09aec7158d35b";
...
pub mod splice_api_token_metadata_v1 {
    pub mod Splice_Api_Token_MetadataV1 {
        ...
        pub struct ExtraArgs {
            #[serde(rename = "context")]
            pub context: crate::splice_api_token_metadata_v1::Splice_Api_Token_MetadataV1::ChoiceContext,
            #[serde(rename = "meta")]
            pub meta: crate::splice_api_token_metadata_v1::Splice_Api_Token_MetadataV1::Metadata,
        }
        impl rt::ToValue for ExtraArgs {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![
                        ("context", rt::ToValue::to_value(& self.context)), ("meta",
                        rt::ToValue::to_value(& self.meta)),
                    ],
                )
            }
        ...
        impl rt::ToValue for Metadata {
            fn to_value(&self) -> rt::Value {
                rt::record(
                    ::std::vec![("values", rt::ToValue::to_value(& self.values)),],
                )
            }
        }
        impl rt::FromValue for Metadata {
            fn from_value(
                ...
                ::core::result::Result::Ok(Self {
                    values: rt::FromValue::from_value(
                            rt::required_field(value, 0usize, "values")?,
                        )
                ...
                match constructor {
                    ...
                    "AV_Party" => {
                        ::core::result::Result::Ok(
                            AnyValue::AV_Party(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AV_Party"))?,
                            ),
                        )
                    }
                    "AV_ContractId" => {
                        ::core::result::Result::Ok(
                            AnyValue::AV_ContractId(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AV_ContractId"))?,
                            ),
                        )
                    }
                    "AV_List" => {
                    ...
                    "AV_Map" => {
                        ::core::result::Result::Ok(
                            AnyValue::AV_Map(
                                rt::FromValue::from_value(payload)
                                    .map_err(|e| e.at("AV_Map"))?,
                            ),
                        )
                    }
                    other => {
                        ::core::result::Result::Err(
                            rt::unexpected_constructor("AnyValue", other),
                        )
                    }
                }
            }
        ...
        impl rt::Contract for AnyContract {
            const PACKAGE_ID: &'static str = "4ded6b668cb3b64f7a88a30874cd41c75829f5e064b3fbbadf41ec7e8363354f";
        ...
        impl rt::Interface for AnyContract {
            type View = crate::splice_api_token_metadata_v1::Splice_Api_Token_MetadataV1::AnyContractView;
        }
